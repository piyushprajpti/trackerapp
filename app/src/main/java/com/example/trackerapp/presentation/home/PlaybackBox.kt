...
@Composable
fun PlaybackBox(
    showPlaybackBox: MutableState<Boolean>,
    ...
    fun onPlayClick() {
        ...
        if (startMillis > endMillis) {
            Toast.makeText(context, "Start time can't be greater than end time", Toast.LENGTH_LONG).show()
        } else if (startMillis == endMillis) {
            Toast.makeText(context, "Start time can't be equal to end time", Toast.LENGTH_LONG).show()
        } else {
...
//            heading
            if (!isPlaybackStarted.value) {
                Row(
                    ...
                    IconButton(onClick = { showPlaybackBox.value = false }) {
                        Icon(
...
//                    end time
                ...
                Row(
                    ...
                    Row {
                        ...
                        SpeedButton(
                            text = "5X",
                            isActive = activeSpeedButton.value == 3,
                            onClick = {
                                activeSpeedButton.value = 3
                            }
                        )
                    }
